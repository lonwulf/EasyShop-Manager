...
import com.lonwulf.labs.camera.ui.objectDetection.ObjectConfirmationGraphic
import com.lonwulf.labs.camera.ui.objectDetection.ObjectGraphicInProminentMode
import com.lonwulf.labs.camera.ui.objectDetection.ObjectReticleGraphic
...
class ProminentObjectProcessor(
    ...
    private val workflowModel: CameraXViewModel,
    ...
    override fun onSuccess(
        ...
        var objects = results
        if (!workflowModel.isCameraLive.value) {
            return
        }
        ...
        if (!hasValidObjects) {
            ...
            workflowModel.setWorkflowState(CameraXViewModel.WorkflowState.DETECTING)
        } else {
            ...
            if (objectBoxOverlapsConfirmationReticle(graphicOverlay, visionObject)) {
                ...
                confirmationController.reset()
                workflowModel.setWorkflowState(CameraXViewModel.WorkflowState.DETECTED)
            }
        }
